...
if __name__ == '__main__':
    for tx_amount in tx_amts:
        ...
        for node in range(node_placement_amt):
            ...
            g = placement_strategies.k_means(g, our_party_id, 1, True)
            ...
            for other_id in other_id_list:
                ...
                g = placement_strategies.k_means(g, other_id, 1, True)
        ...
        # Write to file
        scripts.write_rewards_graph_data(rewards, data_path + "results/", "rewards_k_means_" + str(tx_amount)
